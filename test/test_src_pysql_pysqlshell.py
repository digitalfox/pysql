...
class TestConnectedShellCommands(TestShellCommands):
    ...
    def _create_test_table(self):
        ...
        self.assertFalse(self.capturedStdout.gotPsyqlException(), "Failed to create table")

    def _drop_test_table(self):
        self.exeCmd("drop table gabuzomeu;")
        self.assertFalse(self.capturedStdout.gotPsyqlException(), "Failed to drop table")
    ...
    def test_do_commit(self):
        ...
        self.assertFalse(self.capturedStdout.gotPsyqlException(), "Failed to insert line")
        self.exeCmd("commit")
        self.assertFalse(self.capturedStdout.gotPsyqlException(), "Failed to commit line")
        self.exeCmd("disconnect")
        self.exeCmd("connect %s" % CONNECT_STRING)
    ...
    def test_do_rollback(self):
        ...
        self.assertFalse(self.capturedStdout.gotPsyqlException(), "Failed to rollback line")
        self.exeCmd("count gabuzomeu")
    ...
    def test_do_describe(self):
        ...
        self.assertEqual(self.capturedStdout.readlines()[0], "(no result)")
